...
const CONTROLLER_FEAUTURES_ITEMS = [
    { image: '', text: 'TouchID for added layer of security.', icon: 'fluent:fingerprint-20-regular' },
    { image: '', text: 'Wallet button to quickly access your wallet while in a game.', icon: 'clarity:wallet-line' },
    { image: '', text: 'Haptic Triggers.', icon: "ic:outline-waves" },
    { image: '', text: 'Headphone jack to voice chat.', icon: 'fluent:headphones-28-regular' },
    ...
    return (
        <div className="flex flex-col md:flex-row gap-4 w-full  mb-4">
            <div className="flex flex-col gap-8 md:w-2/5">
                <label className="text-lg font-bold">Controller Featrues</label>
            ...
            <div className="w-full border border-base-300">
                <video className="w-full border" autoPlay={"autoplay"} preload="auto" loop muted>
